...
const Home = () => {
    const [isLoading, setIsLoading] = useState(() => {
        ...
        const hasSeenLoader = localStorage.getItem('aegis-loader-seen');
    ...
    useEffect(() => {
        if (!isLoading) {
            // Mark loader as seen
            localStorage.setItem('aegis-loader-seen', 'true');
    ...
    return (
        <div className="relative min-h-screen overflow-y-auto">
            {/* LetterGlitch Background - Extended across entire page */}
            ...
            <div className="relative min-h-screen">
                {/* Content Layer - Decrypted Text (delayed) */}
                {showText && (
                    <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 md:px-8">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-mono tracking-tighter text-white text-center">
                            <DecryptedText
            ...
            <section className="relative min-h-screen py-20 px-4 sm:px-6 md:px-8 z-10">
